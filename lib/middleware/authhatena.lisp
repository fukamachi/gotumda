(clack.util:namespace gotumda.middleware.authhatena
  (:use :cl
        :clack
        :anaphora)
...
@export
(defclass <gotumda-middleware-authhatena> (<middleware>)
...
(defmethod call ((this <gotumda-middleware-authhatena>) env)
  (if (string-equal (getf env :path-info)
                    (auth-path this))
      (authorize this env)
      (call-next this env)))

(defmethod authorize ((this <gotumda-middleware-authhatena>) env)
  (let ((params
...
(defmethod auth-uri ((this <gotumda-middleware-authhatena>))
  (format nil
...
(defmethod api-uri ((this <gotumda-middleware-authhatena>) params)
  (format nil
...
(defmethod user-info ((this <gotumda-middleware-authhatena>) cert)
